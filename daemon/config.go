...
func (config *Config) InstallCommonFlags(cmd *flag.FlagSet, usageFn func(string) string) {
	...
	cmd.Var(opts.NewListOptsRef(&config.AuthZPlugins, nil), []string{"-authorization-plugin"}, usageFn("List authorization plugins in order from first evaluator to last"))
